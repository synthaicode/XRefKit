...
```powershell
node human-docs/ja/assets/065_xrefkit_repository_overview/render.mjs
```

PNG 作成:

```powershell
python human-docs/ja/assets/065_xrefkit_repository_overview/render_pngs.py
```

無音動画作成:

```powershell
python human-docs/ja/video/065_xrefkit_repository_overview/build_video.py
```
