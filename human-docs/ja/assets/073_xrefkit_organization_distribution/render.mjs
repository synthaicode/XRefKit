...
const slides = [
  {
    ...
    cards: [
      ["Evidence", "実行で使った知識、判断、未解決事項、結果を確認します。"],
      ["人間による評価", "不足、過剰、誤選択、受入条件の妥当性を判断します。"],
      ["改訂候補", "Knowledge、Skill、routing、受入条件へ変更を戻します。"],
    ],
    takeaway: "AIが組織ルールを自動更新せず、<strong>改訂責任は人間</strong>に残します。",
  },
  {
    name: "02_unit",
    ...
    cards: [
      ["改訂", "人間が変更内容と責任範囲を確定します。"],
      ["検証", "XID参照、契約、版、互換性を決定的に確認します。"],
      ["承認", "公開可能な次の版として人間が受け入れます。"],
    ],
    takeaway: "Evidenceから配布までの間に、<strong>人間の評価・改訂・承認</strong>を置きます。",
  },
  {
    name: "03_package",
  ...
  },
  {
    ...
    takeaway: "改善と配布の終点は、<strong>次の業務実行ループ</strong>の開始です。",
  },
];
