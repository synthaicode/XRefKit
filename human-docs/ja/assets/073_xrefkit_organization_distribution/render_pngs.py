...
SLIDES = [
    {
        ...
        "cards": [("配布元", "更新・検証されたリポジトリの正本を使います。"), ("配布単位", "契約、責務定義、必須知識、実行ツールをまとめます。"), ("利用先", "リポジトリ、導入済みパッケージ、MCPから利用します。")],
        "takeaway": "管理と配布を分け、配布先で正本の意味を変えません。",
    },
    {
        "name": "02_unit",
        ...
        "cards": [("起動と進行", "起動契約、作業進行規約、終了条件を含めます。"), ("責務と知識", "選択した責務定義と必要なXID本文を含めます。"), ("実行ツール", "クライアント側で必要な決定的コマンドを含めます。")],
        "takeaway": "配布物は読む情報だけでなく、同じ動作を保つ契約を持ちます。",
    },
    {
        "name": "03_package",
    ...
    },
    {
        ...
        "takeaway": "組織配布は正本を複製することではなく、同じ契約で利用可能にすることです。",
    },
]
