...
const dir = path.resolve("human-docs/ja/assets/xrefkit_repository_snapshot");
    ...
    <section class="main-grid">
      ...
      <section class="panel">
        ...
        <div class="panel-body pipeline">
          <div class="steps">
            <div class="step"><div class="ico">RUN</div><div><h3>開始ゲート</h3><p><code>xrefkit skill run</code> がメタ情報を検査し、Skill を開く前に実行ログを作る。</p></div></div>
            ...
            <div class="flow-down">v</div>
            <div class="step"><div class="ico">QG</div><div><h3>完了と監査</h3><p><code>xrefkit skill close</code> と品質ゲートが、不完全な実行ログを拒否する。</p></div></div>
          </div>
