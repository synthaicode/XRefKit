...
const slides = [
  {
    ...
    copy:
      "Goal、Skill、Knowledge、Semantic routing、Workflow protocol、Evidence、Distributionを、同じ文書へ混ぜずに対応する実装へ配置します。",
    cards: [
      ["Goal・Skill", "Goal stateとSkill packageが、完了条件と限定責務を別々に持ちます。"],
  ...
  {
    name: "08_conclusion",
    question: "知識と手順を、更新・検証できる状態で管理できますか。",
    title: "XRefKitは、知識・手順・実行記録の正本を分けて管理します。",
    copy:
      "責務定義、組織固有知識、実行管理、証拠、元資料を分離し、変更箇所と検証対象を明確にした状態で正本を更新します。",
    cards: [
      ["定義", "責務定義と組織固有知識を別々の正本として更新します。"],
      ["実行", "作業状態と証拠を実行記録へ残し、定義と混ぜません。"],
      ["改善", "利用記録から不足を確認し、承認後に正本へ戻します。"],
    ],
    takeaway: "ここで整えた<strong>検証可能な正本</strong>が、組織へ配布する入力になります。",
  },
];
