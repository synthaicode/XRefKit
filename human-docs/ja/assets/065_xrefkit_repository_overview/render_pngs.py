...
SLIDES = [
    ...
    },
    {
        ...
        "copy": "人向け説明、機械向けフロー、再利用能力、実行手順、共有知識、実行記録、元資料を混ぜずに置くことで、読む相手と目的を分離します。",
        "cards": [
    ...
    },
    {
        ...
        "copy": "fm skill run で開始し、work item、artifact、concern、role separation を記録してから閉じます。Skill を直接読むだけでは閉じられません。",
        "cards": [
    ...
    },
    {
        ...
        "copy": "AI 側で実行とチェックを分け、記録を残したうえで、最後に人間が scope change や risk acceptance のような本来の判断点を持ちます。",
        "cards": [
            ("AI 側で減らす", "記録、自己点検、証拠整理、引き継ぎ確認を先に構造化します。"),
            ("人間が持つ", "優先順位、業務トレードオフ、承認、例外判断です。"),
            ("ねらい", "人間が全部を追うのではなく、判断すべき点だけを見る状態を作ります。"),
        ],
        "takeaway": "人間 review は万能な後追いではなく、境界化された判断点として残します。",
    },
    {
        "name": "08_conclusion",
