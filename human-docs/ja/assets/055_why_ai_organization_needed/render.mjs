...
const renderers = {
  ...
  "05_organization_role": () => slide("分割した責務には、接続する仕組みが必要", "個別作業を速くしても、業務の終点へつながらなければ完了しない", [["現在状態", "何が終わり、何が未了か"], ["次の責務", "いま必要な判断と作業は何か"], ["Goalへの接続", "個別完了を全体完了と混同しない", "soft-green"]], "XRefKitでは、この接続を実行モデルとして分けて扱う。"),
  ...
  "09_conclusion": () => slide("必要なのは、AIの回答ではなく業務実行の構造", "Goal、限定責務、固有Knowledge、状態記録、受入れを分けて接続する", [["終点", "Goalと受入条件を持つ"], ["実行", "限定した責務へ集中させる"], ["継続", "未了を残し、次へ渡す", "soft-green"]], "具体的な接続方法は、Execution Model Deckで説明する。")
};
