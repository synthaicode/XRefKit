...
そのうえで、業務を一つの指示で扱うのではなく、一つの業務を一つの `Business Pack` として AI に依頼し、その中を主に Flow、Skill、Knowledge、Handoff と業務固有の品質観点で構造化し、Guard、共通の Quality Gate、Operational Memory で基盤側から支える考え方を示すのがこの図です。
...
- [06 OS and Flow Monitor Dashboard](06_os_and_flow_monitor_dashboard.md)
