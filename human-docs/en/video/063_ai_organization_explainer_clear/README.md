...
```powershell
node human-docs/en/assets/063_ai_organization_explainer_clear/render.mjs
```

Capture PNGs:

```powershell
$dir='human-docs/en/assets/063_ai_organization_explainer_clear'
...
```powershell
python human-docs/en/video/063_ai_organization_explainer_clear/build_video.py
```
...
python human-docs/en/video/063_ai_organization_explainer_clear/build_azure_voice_video.py
```
