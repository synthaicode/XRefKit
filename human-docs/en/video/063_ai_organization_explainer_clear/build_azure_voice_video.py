...
ANSWER_REVEAL_SECONDS = float(os.environ.get("AZURE_SPEECH_ANSWER_REVEAL_SECONDS", "0.9"))
WAV_RATE = 24000
WAV_CHANNELS = 1
WAV_SAMPLE_WIDTH = 2
FRAME_SIZE = (1600, 900)
...
def main() -> None:
    ...
    for row in read_manifest():
        ...
        if is_answer_reveal:
            build_reveal_segment(previous_slide_path, slide_path, audio_path, segment_path)
        else:
