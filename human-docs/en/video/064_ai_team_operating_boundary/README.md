...
- The rendered slide sources live in `human-docs/en/assets/064_ai_team_operating_boundary/`.
...
```powershell
node human-docs/en/assets/064_ai_team_operating_boundary/render.mjs
```

Capture PNGs:

```powershell
$dir='human-docs/en/assets/064_ai_team_operating_boundary'
...
```powershell
python human-docs/en/video/064_ai_team_operating_boundary/build_video.py
```
