...
const slides = [
  ...
  ["07_human", "Can we see which Knowledge was used after execution?", "Correlated run logs make XID use observable.", "A shared run_id connects Skill Run and MCP events. Selection, resolution, loading, and application remain distinct improvement signals.", [["Correlate", "Join client and MCP events by run_id."], ["Distinguish", "Keep each XID lifecycle event separate."], ["Improve", "Revise catalogs, Skills, and Knowledge from evidence."]]],
