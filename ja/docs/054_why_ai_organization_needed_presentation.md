...
発表メモ:
AI は強力ですが、忘れる、ぶれる、もっともらしく間違う、文脈がなければ外しやすいといった特性があります。ここが従来システムとの大きな違いです。
...
最後の一言:
AI を本番利用につなげるには、プロンプト改善だけで考えるのではなく、対象、手順、知識、確認、役割を揃え、それらを統制された運用として回せる形にすることが出発点になります。こうした統制の単位を持つことが、AI を組織的に扱うことにつながっていきます。
