...
For the authoritative rule, see [Principles](../core/contracts/001_principles.md#xid-71DFD9319CFB).
...
Use the import-specific guidance in [Importing existing documents](003_import_for_humans.md#xid-0CF07930F2FA) and the source-recording rules in [Sources](../reference/020_sources.md#xid-2FAD591BF725).
...
- Extracted knowledge but forgot to record source pointers
  - Fix: follow [Sources](../reference/020_sources.md#xid-2FAD591BF725) and always keep `source_path` + locator (page/sheet/url) at the end of a fragment
...
- Sources: [docs/reference/020_sources.md](../reference/020_sources.md#xid-2FAD591BF725)
- Workflow: [docs/guides/010_workflow.md](010_workflow.md#xid-7D1E1C0279F1)
