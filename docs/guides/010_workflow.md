...
Skill routing selects a method from intent and `applies_when`, then derives the
capability / tuning / responsibility binding from the instruction at run start.
