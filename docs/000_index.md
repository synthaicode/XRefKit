<!-- xid: 56DD6EB68343 -->
<a id="xid-56DD6EB68343"></a>

# Docs Index (Entry)

This `docs/` folder is the human-facing documentation. Agents should treat it as a table of contents and read only the necessary pages by XID.

## First Read

- [Overview](000_overview.md#xid-7C6C2B46A9D1)
- [Principles / Contract](core/contracts/001_principles.md#xid-71DFD9319CFB)
...
- [XRefKit startup contract (repository-native startup target)](core/contracts/080_xrefkit_startup_contract.md#xid-C3A1F78D9B22)
...
- [Business intake workflow](packs/business-intake/067_business_intake_workflow.md#xid-7F2C8DA14E66)
- [Change impact investigation decomposition](designs/068_change_impact_investigation_decomposition.md#xid-14733B9B4F61)
