...
def gateway_contract(*, include_schemas: bool = False) -> dict:
    result = {
        ...
        "instructions": [
            ...
            "Initialize workflow state, then route only dependency-ready pending work items. Persist every returned state; completed nodes are not redispatched.",
            ...
            "External-action authorization is an independent action/scope/status/evidence record. It gates execution but never raises or lowers model tier.",
