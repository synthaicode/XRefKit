...
This is part of the repository's base control layer, not an XRefKit-specific routing rule. See [Base control and xref routing layers](../models/017_base_and_xref_layering.md#xid-5A1C8E4D2F90).
...
3. For a knowledge gap: search domain knowledge first via `python -m xrefkit xref search "<query>"`.
