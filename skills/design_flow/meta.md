...
- input: approved requirements, work plan, source modification policy, data change policy, test policy
- output: approved design, target paths, source modification design, data change design, test design, design basis policy reference
