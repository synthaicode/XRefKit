...
- responsibility: user needs presentation diagrams, figure-first slides, or a one-page repository explainer image where the final visual must be readable and rerenderable
- os_contract: v1
