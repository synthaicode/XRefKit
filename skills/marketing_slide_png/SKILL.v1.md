...
applies_when:
  - user needs readable rerenderable presentation diagrams, figure-first slides, or a one-page repository explainer image
exclusions:
...
inputs:
  - target deck or infographic path, asset directory, slide messages or central claim, diagram structure, repository fact map, branding constraints
outputs:
  - slide-ready or standalone PNG, reusable diagram.css and render.mjs, updated deck Markdown when applicable
criteria:
