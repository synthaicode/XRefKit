...
- responsibility: a task or work session is ending and the agent should determine whether stable rules, knowledge, or procedures must be promoted out of `work/
- os_contract: v1
