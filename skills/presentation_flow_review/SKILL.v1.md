...
applies_when:
  - a slide deck or slide script exists and its explanation is abrupt, repetitive, causally inverted, or difficult to follow
exclusions:
...
inputs:
  - target deck or slide script, intended audience, central claim, optional duration, and factual constraints
outputs:
  - presentation-flow review path, revised slide order, per-slide purpose and bridge statements, prioritized findings, and authoring or rendering handoff
criteria:
