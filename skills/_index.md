...
- `zenn_check`:
  - summary: check Zenn article drafts and optionally rewrite; enforces Zenn markup conventions
  - meta: `skills/zenn_check/meta.md`
  - skill_doc: `skills/zenn_check/SKILL.md`
- `csharp_review`:
