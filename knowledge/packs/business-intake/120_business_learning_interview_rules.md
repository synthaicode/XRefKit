...
If ownership and business interpretation are both still provisional and no
confirmation owner can be named, `ready_for_scoping` is not permitted.

In that case:

- keep the cycle in interview-stage learning
- preserve the provisional ownership and interpretation explicitly
- ask for the smallest next confirmation that can identify the confirmation
  owner or resolve the interpretation boundary
